...
| 4   | · фильтр с плавающей загрузкой                       | секция   | 1      | Фпз.6.2         |
...
| 12  | · отсек денитрификации                               | секция   | 1×2    | БЧдр#.1         |
| 13  | · аэротенк-нитрификатор                              | секция   | 1×2    | БЧнт#.2         |
| 14  | · мелкопузырчатый тарельчатый аэратор                | шт.      | 8×2    | БЧаэр#.4        |
| 15  | · мешалка лопастная                                  | шт.      | 1×2    | БЧмшл#.5        |
| 16  | Блок вторичных отстойников. В составе:               | шт.      | 1      | Бвт.5           |
| 17  | · вторичный отстойник                                | секция   | 2      | Бвт.5.1 Бвт.5.2 |
...
псв22 (Ду65) - Подача сточных вод на очистку
 
мос23 (Ду50) - Механически очищенные сточные воды.
мос24 (Ду50) - Механически очищенные сточные воды.
 оп27 (Ду50) - Отвод песка
 ог29 (Ду80) - Отвод грязной промывной воды
...
Из канализационной насосной станции сточные воды по напорному коллектору (_Псв20_) поступают
в установку «Сток УСБ-100» и подаются на механическую очистку в барабанное сито (**Бс1.1**).
...
Из камеры вода распределяется на два блока биологической очистки (**БиоЧист.3,4**). 
По трубам _мос23 мос24_.

Блоки биологической очистки разделены на отсек денитрификации (**БЧдр**) и аэротенк-нитрификатор (**БЧнт**). 
...
Сначала стоки поступают в отсеки денитрификации. (**БЧдр**) В них происходят процессы потребления 
...
Из отсеков денитрификации иловая смесь поступает в аэротенки-нитрификаторы (**БЧнт**), 
